		...
		<div class="card-body">
			<form action="{{ route('content.update', $content->id) }}" class="form" method="post">
				...
				<div class="form-group">
					...
					<textarea name="content" id="content-ckeditor" cols="30" rows="10" class="form-control rounded-0">{{ old('content') ?? $content->content }}</textarea>
				</div>
				<div class="form-group">
					<label for="">Excerpt</label>
					<textarea name="excerpt" id="" cols="30" rows="10" class="form-control rounded-0">{{ old('excerpt') ?? $content->excerpt }}</textarea>
				</div>
				<div class="form-group">
